...
namespace TiendaMusica.Data.InsightDB
{
    public class AlbumGenericRepository : IGenericRepository<Album>
    {
        ...
        {
            db.ExecuteSql("update album set Title=@Title where AlbumId=@AlbumId and ArtistId=@ArtistId", new { Title=entity.Title, AlbumId = entity.AlbumId, ArtistId = entity.ArtistId });
            //throw new NotImplementedException();
        }
